...
class StudentController extends AbstractController
{
    ...
    /**
     * @Rest\Route("students-by-department", name="app_students_by_department", methods={"GET"})
     */
    public function studentsByDepartment(DepartmentRepository $departmentRepository): Response
    {
        return $this->render('student/students_by_department.twig', [
